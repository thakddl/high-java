...
public class T04_ListSortTest {
	public static void main(String[] args) {
		...
		System.out.println("번호의 내름차순으로 정렬 후 : ");
		for (Member mem : memList) {
			System.out.println(mem);
		}
		System.out.println("--------------------------------");
...
//			return 1;
//		}
		//wrapper클래스에서 제공하는 메서드를 이용하는 방법(이미 compareTo가 구현되어 있다.)
		return new Integer(mem1.getNum()).compareTo(mem2.getNum());
	}

}

class Member implements Comparable<Member> {// Comparable:객체 자제에다가 정렬기능을 부여해주고 싶을때 이 인터페이스를 쓴다.
