...
public class T01_FileTest {
	public static void main(String[] args) throws IOException {
		...
		// 생성자에 설정해준 경로
		System.out.println("경로 : " + file4.getPath());//내가 써놓은 경로
		System.out.println("표준 경로 : " + file4.getCanonicalPath());//계산된 경로
		System.out.println("-------------------------------------");
		
		/*
		 * 디렉토리(폴더) 만들기
		 * 1. mkdir() => File객체의 경로중 마지막 위치의 디렉토리를 만든다.
		 * 			  => 중간의 경로가 모두 만들어져 있어야 한다.
		 * 2. mkdirs() => 중간의 경로가 없으면 중간의 경로도 새롭게 만든후 마지막 위치의 디렉토리를 만들어준다.
		 * => 위 두 메소드 모두 만들기를 성공하면 boolean을 반환한다.
		 * 물론 운영체제에서 권한이 있어야 한다.
		*/
